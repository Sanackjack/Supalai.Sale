...
public class AuthCustomRepository : IAuthCustomRepository
{
   ...
   public List<SysUserInfo>? FindSysUserInfoRawSqlByUserName(string userName)
   {
      ...
      List<SysUserInfo>? sysUserInfos = _db.SysUserInfo.FromSqlRaw<SysUserInfo>(
            ...
            where SAU.ADUser = 'Yes' and SAU.IsDelete = 0 and SAB.isDelete = 0 and SAR.isDelete = 0 and SAU.Username = @Name",name)
