...
public class MasterDataService  :IMasterDataService
{
    ...
    public void InitialMasterData()
    {
        ...
        // var str =GetContentResultFromBlob(_configuration["BlobStorage:ContainerName"],"introduce_type.json");
        // var IntroductionTypeData = JsonConvert.DeserializeObject<IntroductionTypeData>(str);
